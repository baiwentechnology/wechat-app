...
public class StringUtils {
    ...
    public static Integer getListIntegerValue(List<String> list, int index) {
        String str = getListValue(list, index);
        if (StringUtils.isEmpty(str)) {
            return 0;
        }
    ...
    public static Long getListLongValue(List<String> list, int index) {
        String str = getListValue(list, index);
        if (StringUtils.isEmpty(str)) {
            return 0l;
        }
    ...
    public static String replaceJson(String str) {
        ...
        src = replaceChars(src, "\t", "");
        src = replaceChars(src, "\r", "");
        src = replaceChars(src, "\n", "");
        return src;
    }
    ...
    public static String replaceAccessURLReg(String url, String name, String accessToken) {
        if (isNotBlank(url) && isNotBlank(accessToken)) {
    ...
    public static String replaceSQL(String source) {
        if (StringUtils.isEmpty(source)) {
            return source;
        }
        String value = new String(source);
